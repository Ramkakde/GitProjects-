...
namespace SignUpService.DataAccess
{
    public class CustomerDA
    {
        ...
        #region Private database transaction methods which should be access same class
        // DB transactions.
        /// <summary>
        ...
        // DB transactions.
        /// <summary>
        /// Delete Contact  Customer Detail in database tranSaction
        /// </summary>
        /// <param name="practInfo"></param>
        /// <returns></returns>
        private int DeleteContactDBTranSaction(CustomerInfo practInfo)
        {
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Usp_DeleteContactDetails";
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add(practInfo.ContactDetailUID == "" ? new SqlParameter("@ContactDetailUID", DBNull.Value) : new SqlParameter("@ContactDetailUID", practInfo.ContactDetailUID));
            DBHelper db = new DBHelper("myConnectionString");
            return db.ExecuteNonQuery(cmd);
        ...
        #region Public method which is accessable drived class
        ...
        public int DeleteContact(CustomerInfo custInfo)
        {
            return DeleteContactDBTranSaction(custInfo);
